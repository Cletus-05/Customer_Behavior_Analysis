...
select subscription_status ,count(customer_id) as count,avg(purchase_amount) as avg_spend, sum(purchase_amount) as total_revenue
from customer
group by subscription_status
order by avg_spend,total_revenue desc;

-- Q6. Which 5 products have the highest percentage of purchases with discounts applied?
select item_purchased, round(100.0 * sum(case when discount_applied="Yes" then 1 else 0 end),2)/count(*) as discount_rate
from customer
group by item_purchased
